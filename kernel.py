...
def fake_info():
    ...
    a.json()
    print(colorama.Fore.CYAN+'{\n"craeted by":"@e_l_f_6_6_6"'+json.dumps(a.json(), indent=4, separators=(" , ", " ==> :  ")))
    print('''\n\n"my channel":"@elf_security_cyber"\n\n\n       }   ''')   
...
def korona():
    ...
    x.json()
    print(colorama.Fore.CYAN+'{\n"craeted by":"@e_l_f_6_6_6"'+json.dumps(x.json(), indent=4, separators=(" , ", " ==> :  ")))
    print('''
...
def music():
    ...
    print(colorama.Fore.CYAN+'{\n"craeted by":"@e_l_f_6_6_6"'+json.dumps(respons.json(), indent=4, separators=(" , ", " ==> :  ")))
...
def tabir_khab():
    ...
    respons.json()  
    print(colorama.Fore.CYAN+'{ "craeted by : @e_l_f_6_6_6"'+json.dumps(respons.json(), indent=4, separators=(" , ", " ==> :  ")))
    print('\n' +' #  my channel : @elf-security_cyber       }   ')   
...
def bio():
    ...
    a.encoding = 'utf-8'
    b.json()
    print(colorama.Fore.CYAN+'{ "craeted by":"@e_l_f_6_6_6"'+json.dumps(b.json(), indent=4, separators=(" , ", " ==> :  ")))
    print('''
...
def channel():
        ...
        b.json()
        b.encoding = 'utf-8'
        print(colorama.Fore.CYAN+'{\n"craeted by":"@e_l_f_6_6_6"'+json.dumps(b.json(), indent=4, separators=(" , ", " ==> :  ")))
        print('''"my channel":"@elf_security_cyber"\n\n\n       }   ''')    
def info_insta():
...
def irancell():
        ...
        response.json()
        print(colorama.Fore.CYAN+'{\n"craeted by":"@e_l_f_6_6_6"'+json.dumps(response.json(), indent=4, separators=(" , ", " ==> :  ")))
        print('''\n\n"my channel":"@elf_security_cyber"\n\n\n       }   ''')        
def tavalod():
